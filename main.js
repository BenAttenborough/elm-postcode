...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'LinkClicked':
				var response = msg.a;
				var _v1 = A2($elm$core$Debug$log, 'x', 'y');
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			default:
				var url = msg.a;
				var _v2 = A2($elm$core$Debug$log, 'url', url);
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
	...
	function (flags, url, navKey) {
		...
		return postcodeInUrl ? A2(
				...
				A2($elm$core$String$dropLeft, 1, url.path)),
			{
				currentRoute: url,
				navKey: navKey,
				postCode: A2($elm$core$String$dropLeft, 1, url.path),
				postCodeInfo: $krisajenkins$remotedata$RemoteData$NotAsked,
				postCodeNearby: $krisajenkins$remotedata$RemoteData$NotAsked
			}) : _Utils_Tuple2(
			{currentRoute: url, navKey: navKey, postCode: '', postCodeInfo: $krisajenkins$remotedata$RemoteData$NotAsked, postCodeNearby: $krisajenkins$remotedata$RemoteData$NotAsked},
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Main$currentView = function (_v0) {
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.PostcodeDetails":{"args":[],"type":"{ postcode : String.String, country : String.String, region : String.String }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"RemoteData.WebData":{"args":["a"],"type":"RemoteData.RemoteData Http.Error a"}},"unions":{"Main.Msg":{"args":[],"tags":{"OnChange":["String.String"],"OnKeyDown":["Basics.Int"],"Submit":["String.String"],"GotPostcode":["RemoteData.WebData Main.PostcodeDetails"],"GotPostcodeNearby":["RemoteData.WebData (List.List Main.PostcodeDetails)"],"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Loading":[],"Failure":["e"],"Success":["a"]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));